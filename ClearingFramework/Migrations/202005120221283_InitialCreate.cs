                ...
                c => new
                    {
                        ...
                        freezeValue = c.Int(),
                        totalNumber = c.Decimal(precision: 18, scale: 2),
                        assetId = c.Int(),
                ...
                c => new
                    {
                        ...
                        ratio = c.Decimal(precision: 10, scale: 2),
                ...
                c => new
                    {
                        ...
                        buy = c.Decimal(precision: 18, scale: 6),
                        sell = c.Decimal(precision: 18, scale: 6),
                        buytype = c.Short(),
                        selltype = c.Short(),
                        modified = c.DateTime(),
                        mbuy = c.Decimal(precision: 18, scale: 6),
                        msell = c.Decimal(precision: 18, scale: 6),
                        coid = c.Long(),
                    })
                ...
                c => new
                    {
                        ...
                        ticks = c.Int(),
                        description = c.String(maxLength: 128, fixedLength: true),
                        orderlimit = c.Int(),
                        state = c.Short(),
                        modified = c.DateTime(),
                    })
                ...
                c => new
                    {
                        ...
                        last = c.Decimal(precision: 18, scale: 2),
